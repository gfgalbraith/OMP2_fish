...
This script is designed to take raw eventmeasure csv files (or similar) and pull out separate dataframes for different analyses. 
...
# UPDATE: NA values corrected in csv files
```
...
write.csv(fish, file= "../0_data/ROV_cucumber_data.csv", row.names = FALSE)
